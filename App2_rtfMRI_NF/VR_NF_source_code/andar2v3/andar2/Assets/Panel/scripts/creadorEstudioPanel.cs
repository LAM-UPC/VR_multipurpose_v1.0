        ...
        if (creador) {//Pantalla de creación de un nuevo proyecto
            ...
            if (actividad != "Ninguna")
            {
                ...
                if (actividad == "Paseo por el lago")
                {
                    ...
                    switch (idioma) {case 0: txt = "Electromagnètic"; break; case 1: txt = "Electromagnético"; break; case 2: txt = "MRI"; break; }
        ...
        for (int i = 0; i < grupos.Length-1; i++) {
            ...
            for (int j = 0; j<elementos.Length; j++)
            {
                ...
                for (int k = 0; k<palabras.Length; k++) {
                    if (palabras[k]=="nombre") { nombres[i] = palabras[k + 2]; }
                    if (palabras[k] == "apellidos") { apellidos[i] = palabras[k + 2]; }
                }
            }
        }
